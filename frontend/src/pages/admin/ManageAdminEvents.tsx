...
const ManageAdminEvents: React.FC = () => {
  const { user } = useAuth();
  ...
  const filteredEvents = events.filter(event => {
    const matchesSearch = event.title.toLowerCase().includes(searchQuery.toLowerCase()) ||
                         ...
                         event.postedBy.firstName.toLowerCase().includes(searchQuery.toLowerCase()) ||
                         event.postedBy.lastName.toLowerCase().includes(searchQuery.toLowerCase());
      ...
      <div className="p-8">
        ...
        >
          <div className="flex justify-between items-center">
            <div>
              <h1 className="text-3xl font-bold text-gray-900 mb-2">Manage All Events</h1>
        ...
        >
          <div className="flex flex-col md:flex-row gap-4">
            <div className="flex-1 relative">
              ...
              <input
                type="text"
                placeholder="Search events, organizers, or creators..."
